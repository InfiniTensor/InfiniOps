#ifndef INFINI_OPS_TORCH_FLASH_ATTN_WITH_KVCACHE_FLASH_ATTN_H_
#define INFINI_OPS_TORCH_FLASH_ATTN_WITH_KVCACHE_FLASH_ATTN_H_
...
template <>
class Operator<FlashAttnWithKvcache, Device::Type::kNvidia, 8>
...
#endif  // INFINI_OPS_TORCH_FLASH_ATTN_WITH_KVCACHE_FLASH_ATTN_H_
