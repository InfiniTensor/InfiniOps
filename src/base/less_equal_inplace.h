#ifndef INFINI_OPS_BASE_LESS_EQUAL_INPLACE_H_
#define INFINI_OPS_BASE_LESS_EQUAL_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class LessEqualInplace : public Operator<LessEqualInplace> {
 public:
  LessEqualInplace(Tensor input, const double other)
  ...
  LessEqualInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
