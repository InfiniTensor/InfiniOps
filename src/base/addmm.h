#ifndef INFINI_OPS_BASE_ADDMM_H_
#define INFINI_OPS_BASE_ADDMM_H_

#include "operator.h"

namespace infini::ops {

class Addmm : public Operator<Addmm> {
 public:
  Addmm(const Tensor input, const Tensor mat1, const Tensor mat2,
