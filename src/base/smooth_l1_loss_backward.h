#ifndef INFINI_OPS_BASE_SMOOTH_L1_LOSS_BACKWARD_H_
#define INFINI_OPS_BASE_SMOOTH_L1_LOSS_BACKWARD_H_

#include "operator.h"

namespace infini::ops {

class SmoothL1LossBackward : public Operator<SmoothL1LossBackward> {
 public:
  SmoothL1LossBackward(const Tensor grad_output, const Tensor input,
