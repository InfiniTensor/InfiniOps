#ifndef INFINI_OPS_BASE_LOGADDEXP_H_
#define INFINI_OPS_BASE_LOGADDEXP_H_

#include "operator.h"

namespace infini::ops {

class Logaddexp : public Operator<Logaddexp> {
 public:
  Logaddexp(const Tensor input, const Tensor other, Tensor out)
