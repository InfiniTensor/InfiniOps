#ifndef INFINI_OPS_BASE_MAX_POOL2D_WITH_INDICES_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_MAX_POOL2D_WITH_INDICES_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class MaxPool2dWithIndicesBackwardGradInput
    : public Operator<MaxPool2dWithIndicesBackwardGradInput> {
 public:
  MaxPool2dWithIndicesBackwardGradInput(
