#ifndef INFINI_OPS_BASE_GELU_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_GELU_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class GeluBackwardGradInput : public Operator<GeluBackwardGradInput> {
 public:
  GeluBackwardGradInput(const Tensor grad_output, const Tensor self,
                        Tensor grad_input)
