#ifndef INFINI_OPS_BASE_ATEN_CONV_DEPTHWISE2D_H_
#define INFINI_OPS_BASE_ATEN_CONV_DEPTHWISE2D_H_
...
class AtenConvDepthwise2d : public Operator<AtenConvDepthwise2d> {
 public:
  AtenConvDepthwise2d(const Tensor input, const Tensor weight,
