#ifndef INFINI_OPS_BASE_BITWISE_AND_H_
#define INFINI_OPS_BASE_BITWISE_AND_H_

#include "operator.h"

namespace infini::ops {

class BitwiseAnd : public Operator<BitwiseAnd> {
 public:
  BitwiseAnd(const Tensor input, const Tensor other, Tensor out)
  ...
  BitwiseAnd(const Tensor input, const double other, Tensor out)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        out_shape_{out.shape()},
  ...
  BitwiseAnd(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
  ...
  BitwiseAnd(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_shape_{other.shape()},
