#ifndef INFINI_OPS_BASE_GT_TENSOR_H_
#define INFINI_OPS_BASE_GT_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class GtTensor : public Operator<GtTensor> {
 public:
  GtTensor(const Tensor self, const Tensor other, Tensor out)
