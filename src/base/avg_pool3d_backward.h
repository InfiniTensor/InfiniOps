#ifndef INFINI_OPS_BASE_AVG_POOL3D_BACKWARD_H_
#define INFINI_OPS_BASE_AVG_POOL3D_BACKWARD_H_
...
class AvgPool3dBackward : public Operator<AvgPool3dBackward> {
 public:
  AvgPool3dBackward(const Tensor grad_output, const Tensor input,
