#ifndef INFINI_OPS_BASE_INTERNAL_SCALED_MM_H_
#define INFINI_OPS_BASE_INTERNAL_SCALED_MM_H_
...
class ScaledMm : public Operator<ScaledMm> {
 public:
  ScaledMm(const Tensor input, const Tensor mat2, const Tensor scale_a,
           const Tensor scale_b, const std::optional<Tensor> bias,
           const std::optional<Tensor> scale_result,
           const std::optional<DataType> out_dtype, const bool use_fast_accum,
           Tensor out)
