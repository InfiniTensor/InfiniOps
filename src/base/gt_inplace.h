#ifndef INFINI_OPS_BASE_GT_INPLACE_H_
#define INFINI_OPS_BASE_GT_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class GtInplace : public Operator<GtInplace> {
 public:
  GtInplace(Tensor input, const double other)
  ...
  GtInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
