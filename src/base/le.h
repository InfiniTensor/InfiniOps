#ifndef INFINI_OPS_BASE_LE_H_
#define INFINI_OPS_BASE_LE_H_

#include "operator.h"

namespace infini::ops {

class Le : public Operator<Le> {
 public:
  Le(const Tensor input, const double other, Tensor out)
  ...
  Le(const Tensor input, const Tensor other, Tensor out)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        out_shape_{out.shape()},
  ...
  Le(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
  ...
  Le(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_shape_{other.shape()},
