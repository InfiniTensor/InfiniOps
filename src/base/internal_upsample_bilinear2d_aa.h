#ifndef INFINI_OPS_BASE_INTERNAL_UPSAMPLE_BILINEAR2D_AA_H_
#define INFINI_OPS_BASE_INTERNAL_UPSAMPLE_BILINEAR2D_AA_H_
...
class UpsampleBilinear2dAa : public Operator<UpsampleBilinear2dAa> {
 public:
  UpsampleBilinear2dAa(const Tensor input,
