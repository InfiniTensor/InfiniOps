#ifndef INFINI_OPS_BASE_UPSAMPLE_NEAREST2D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_UPSAMPLE_NEAREST2D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class UpsampleNearest2dBackwardGradInput
    : public Operator<UpsampleNearest2dBackwardGradInput> {
 public:
  UpsampleNearest2dBackwardGradInput(const Tensor grad_output,
