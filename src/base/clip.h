#ifndef INFINI_OPS_BASE_CLIP_H_
#define INFINI_OPS_BASE_CLIP_H_
...
class Clip : public Operator<Clip> {
 public:
  Clip(const Tensor input, const std::optional<double> min,
  ...
  Clip(const Tensor input, const std::optional<Tensor> min,
