#ifndef INFINI_OPS_BASE_LT_TENSOR_H_
#define INFINI_OPS_BASE_LT_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class LtTensor : public Operator<LtTensor> {
 public:
  LtTensor(const Tensor self, const Tensor other, Tensor out)
