#ifndef INFINI_OPS_BASE_NEXTAFTER_H_
#define INFINI_OPS_BASE_NEXTAFTER_H_

#include "operator.h"

namespace infini::ops {

class Nextafter : public Operator<Nextafter> {
 public:
  Nextafter(const Tensor input, const Tensor other, Tensor out)
