#ifndef INFINI_OPS_BASE_MINIMUM_H_
#define INFINI_OPS_BASE_MINIMUM_H_

#include "operator.h"

namespace infini::ops {

class Minimum : public Operator<Minimum> {
 public:
  Minimum(const Tensor input, const Tensor other, Tensor out)
