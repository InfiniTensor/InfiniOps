#ifndef INFINI_OPS_BASE_LE_TENSOR_H_
#define INFINI_OPS_BASE_LE_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class LeTensor : public Operator<LeTensor> {
 public:
  LeTensor(const Tensor self, const Tensor other, Tensor out)
