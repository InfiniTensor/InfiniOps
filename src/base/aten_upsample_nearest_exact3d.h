#ifndef INFINI_OPS_BASE_ATEN_UPSAMPLE_NEAREST_EXACT3D_H_
#define INFINI_OPS_BASE_ATEN_UPSAMPLE_NEAREST_EXACT3D_H_
...
class AtenUpsampleNearestExact3d : public Operator<AtenUpsampleNearestExact3d> {
 public:
  AtenUpsampleNearestExact3d(const Tensor input,
