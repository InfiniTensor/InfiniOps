#ifndef INFINI_OPS_BASE_FRACTIONAL_MAX_POOL3D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_FRACTIONAL_MAX_POOL3D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class FractionalMaxPool3dBackwardGradInput
    : public Operator<FractionalMaxPool3dBackwardGradInput> {
 public:
  FractionalMaxPool3dBackwardGradInput(const Tensor grad_output,
                                       const Tensor self,
