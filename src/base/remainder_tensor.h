#ifndef INFINI_OPS_BASE_REMAINDER_TENSOR_H_
#define INFINI_OPS_BASE_REMAINDER_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class RemainderTensor : public Operator<RemainderTensor> {
 public:
  RemainderTensor(const Tensor self, const Tensor other, Tensor out)
