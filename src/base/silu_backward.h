#ifndef INFINI_OPS_BASE_SILU_BACKWARD_H_
#define INFINI_OPS_BASE_SILU_BACKWARD_H_

#include "operator.h"

namespace infini::ops {

class SiluBackward : public Operator<SiluBackward> {
 public:
  SiluBackward(const Tensor grad_output, const Tensor input, Tensor grad_input)
