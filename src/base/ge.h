#ifndef INFINI_OPS_BASE_GE_H_
#define INFINI_OPS_BASE_GE_H_

#include "operator.h"

namespace infini::ops {

class Ge : public Operator<Ge> {
 public:
  Ge(const Tensor input, const double other, Tensor out)
  ...
  Ge(const Tensor input, const Tensor other, Tensor out)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        out_shape_{out.shape()},
