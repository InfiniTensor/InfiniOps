#ifndef INFINI_OPS_BASE_KTHVALUE_H_
#define INFINI_OPS_BASE_KTHVALUE_H_

#include "operator.h"

namespace infini::ops {

class Kthvalue : public Operator<Kthvalue> {
 public:
  Kthvalue(const Tensor input, const int64_t k, const int64_t dim,
           const bool keepdim, Tensor values, Tensor indices)
  ...
  virtual void operator()(const Tensor input, const int64_t k,
                          const int64_t dim, const bool keepdim, Tensor values,
