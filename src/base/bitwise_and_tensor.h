#ifndef INFINI_OPS_BASE_BITWISE_AND_TENSOR_H_
#define INFINI_OPS_BASE_BITWISE_AND_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class BitwiseAndTensor : public Operator<BitwiseAndTensor> {
 public:
  BitwiseAndTensor(const Tensor self, const Tensor other, Tensor out)
