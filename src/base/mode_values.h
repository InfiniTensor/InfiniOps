#ifndef INFINI_OPS_BASE_MODE_VALUES_H_
#define INFINI_OPS_BASE_MODE_VALUES_H_

#include "operator.h"

namespace infini::ops {

class ModeValues : public Operator<ModeValues> {
 public:
  ModeValues(const Tensor self, Tensor values, Tensor indices)
