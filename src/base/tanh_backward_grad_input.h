#ifndef INFINI_OPS_BASE_TANH_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_TANH_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class TanhBackwardGradInput : public Operator<TanhBackwardGradInput> {
 public:
  TanhBackwardGradInput(const Tensor grad_output, const Tensor output,
                        Tensor grad_input)
