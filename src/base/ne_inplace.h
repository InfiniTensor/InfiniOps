#ifndef INFINI_OPS_BASE_NE_INPLACE_H_
#define INFINI_OPS_BASE_NE_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class NeInplace : public Operator<NeInplace> {
 public:
  NeInplace(Tensor input, const double other)
  ...
  NeInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
