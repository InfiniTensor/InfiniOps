#ifndef INFINI_OPS_BASE_KTHVALUE_VALUES_H_
#define INFINI_OPS_BASE_KTHVALUE_VALUES_H_

#include "operator.h"

namespace infini::ops {

class KthvalueValues : public Operator<KthvalueValues> {
 public:
  KthvalueValues(const Tensor self, const int64_t k, Tensor values,
                 Tensor indices)
