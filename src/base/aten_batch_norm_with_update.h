#ifndef INFINI_OPS_BASE_ATEN_BATCH_NORM_WITH_UPDATE_H_
#define INFINI_OPS_BASE_ATEN_BATCH_NORM_WITH_UPDATE_H_
...
class AtenBatchNormWithUpdate : public Operator<AtenBatchNormWithUpdate> {
 public:
  AtenBatchNormWithUpdate(const Tensor input,
