#ifndef INFINI_OPS_BASE_ATEN_LINALG_EIGH_H_
#define INFINI_OPS_BASE_ATEN_LINALG_EIGH_H_
...
class AtenLinalgEigh : public Operator<AtenLinalgEigh> {
 public:
  AtenLinalgEigh(const Tensor A, const std::string UPLO, const bool compute_v,
