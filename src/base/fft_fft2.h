#ifndef INFINI_OPS_BASE_FFT_FFT2_H_
#define INFINI_OPS_BASE_FFT_FFT2_H_
...
class FftFft2 : public Operator<FftFft2> {
 public:
  FftFft2(const Tensor input, const std::optional<std::vector<int64_t>> s,
