#ifndef INFINI_OPS_BASE_SOFTSHRINK_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_SOFTSHRINK_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class SoftshrinkBackwardGradInput
    : public Operator<SoftshrinkBackwardGradInput> {
 public:
  SoftshrinkBackwardGradInput(const Tensor grad_output, const Tensor self,
