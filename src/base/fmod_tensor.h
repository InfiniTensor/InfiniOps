#ifndef INFINI_OPS_BASE_FMOD_TENSOR_H_
#define INFINI_OPS_BASE_FMOD_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class FmodTensor : public Operator<FmodTensor> {
 public:
  FmodTensor(const Tensor self, const Tensor other, Tensor out)
