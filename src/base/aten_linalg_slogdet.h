#ifndef INFINI_OPS_BASE_ATEN_LINALG_SLOGDET_H_
#define INFINI_OPS_BASE_ATEN_LINALG_SLOGDET_H_

#include "operator.h"

namespace infini::ops {

class AtenLinalgSlogdet : public Operator<AtenLinalgSlogdet> {
 public:
  AtenLinalgSlogdet(const Tensor A, Tensor sign, Tensor logabsdet, Tensor LU,
                    Tensor pivots)
      : A_shape_{A.shape()},
