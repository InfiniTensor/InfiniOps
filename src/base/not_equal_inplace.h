#ifndef INFINI_OPS_BASE_NOT_EQUAL_INPLACE_H_
#define INFINI_OPS_BASE_NOT_EQUAL_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class NotEqualInplace : public Operator<NotEqualInplace> {
 public:
  NotEqualInplace(Tensor input, const double other)
  ...
  NotEqualInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
