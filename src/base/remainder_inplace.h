#ifndef INFINI_OPS_BASE_REMAINDER_INPLACE_H_
#define INFINI_OPS_BASE_REMAINDER_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class RemainderInplace : public Operator<RemainderInplace> {
 public:
  RemainderInplace(Tensor input, const double other)
  ...
  RemainderInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
