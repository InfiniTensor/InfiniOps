#ifndef INFINI_OPS_BASE_REPLICATION_PAD2D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_REPLICATION_PAD2D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class ReplicationPad2dBackwardGradInput
    : public Operator<ReplicationPad2dBackwardGradInput> {
 public:
  ReplicationPad2dBackwardGradInput(const Tensor grad_output, const Tensor self,
