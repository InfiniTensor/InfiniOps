#ifndef INFINI_OPS_BASE_INTERNAL_UPSAMPLE_NEAREST_EXACT3D_H_
#define INFINI_OPS_BASE_INTERNAL_UPSAMPLE_NEAREST_EXACT3D_H_
...
class UpsampleNearestExact3d : public Operator<UpsampleNearestExact3d> {
 public:
  UpsampleNearestExact3d(const Tensor input,
