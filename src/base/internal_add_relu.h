#ifndef INFINI_OPS_BASE_INTERNAL_ADD_RELU_H_
#define INFINI_OPS_BASE_INTERNAL_ADD_RELU_H_

#include "operator.h"

namespace infini::ops::internal {

class AddRelu : public Operator<AddRelu> {
 public:
  AddRelu(const Tensor input, const Tensor other, const double alpha,
          Tensor out)
