#ifndef INFINI_OPS_BASE_FRACTIONAL_MAX_POOL2D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_FRACTIONAL_MAX_POOL2D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class FractionalMaxPool2dBackwardGradInput
    : public Operator<FractionalMaxPool2dBackwardGradInput> {
 public:
  FractionalMaxPool2dBackwardGradInput(const Tensor grad_output,
                                       const Tensor self,
