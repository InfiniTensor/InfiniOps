#ifndef INFINI_OPS_BASE_FFT_IHFFTN_H_
#define INFINI_OPS_BASE_FFT_IHFFTN_H_
...
class FftIhfftn : public Operator<FftIhfftn> {
 public:
  FftIhfftn(const Tensor input, const std::optional<std::vector<int64_t>> s,
