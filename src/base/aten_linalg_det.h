#ifndef INFINI_OPS_BASE_ATEN_LINALG_DET_H_
#define INFINI_OPS_BASE_ATEN_LINALG_DET_H_

#include "operator.h"

namespace infini::ops {

class AtenLinalgDet : public Operator<AtenLinalgDet> {
 public:
  AtenLinalgDet(const Tensor A, Tensor result, Tensor LU, Tensor pivots)
      : A_shape_{A.shape()},
