#ifndef INFINI_OPS_BASE_MAX_POOL2D_WITH_INDICES_BACKWARD_H_
#define INFINI_OPS_BASE_MAX_POOL2D_WITH_INDICES_BACKWARD_H_
...
class MaxPool2dWithIndicesBackward
    : public Operator<MaxPool2dWithIndicesBackward> {
 public:
  MaxPool2dWithIndicesBackward(const Tensor grad_output, const Tensor input,
