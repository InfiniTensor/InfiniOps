#ifndef INFINI_OPS_BASE_BITWISE_RIGHT_SHIFT_INPLACE_H_
#define INFINI_OPS_BASE_BITWISE_RIGHT_SHIFT_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class BitwiseRightShiftInplace : public Operator<BitwiseRightShiftInplace> {
 public:
  BitwiseRightShiftInplace(Tensor input, const Tensor other)
  ...
  BitwiseRightShiftInplace(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
