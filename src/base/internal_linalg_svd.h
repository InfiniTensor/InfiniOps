#ifndef INFINI_OPS_BASE_INTERNAL_LINALG_SVD_H_
#define INFINI_OPS_BASE_INTERNAL_LINALG_SVD_H_
...
class Svd : public Operator<Svd> {
 public:
  Svd(const Tensor A, const bool full_matrices, const bool compute_uv,
