#ifndef INFINI_OPS_BASE_UPSAMPLE_BICUBIC2D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_UPSAMPLE_BICUBIC2D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class UpsampleBicubic2dBackwardGradInput
    : public Operator<UpsampleBicubic2dBackwardGradInput> {
 public:
  UpsampleBicubic2dBackwardGradInput(const Tensor grad_output,
