#ifndef INFINI_OPS_BASE_LOGSPACE_TENSOR_SCALAR_H_
#define INFINI_OPS_BASE_LOGSPACE_TENSOR_SCALAR_H_

#include "operator.h"

namespace infini::ops {

class LogspaceTensorScalar : public Operator<LogspaceTensorScalar> {
 public:
  LogspaceTensorScalar(const Tensor start, const double end,
