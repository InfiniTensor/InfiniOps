#ifndef INFINI_OPS_BASE_ARCTAN2_H_
#define INFINI_OPS_BASE_ARCTAN2_H_

#include "operator.h"

namespace infini::ops {

class Arctan2 : public Operator<Arctan2> {
 public:
  Arctan2(const Tensor input, const Tensor other, Tensor out)
