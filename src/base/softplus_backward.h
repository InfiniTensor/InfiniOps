#ifndef INFINI_OPS_BASE_SOFTPLUS_BACKWARD_H_
#define INFINI_OPS_BASE_SOFTPLUS_BACKWARD_H_

#include "operator.h"

namespace infini::ops {

class SoftplusBackward : public Operator<SoftplusBackward> {
 public:
  SoftplusBackward(const Tensor grad_output, const Tensor input,
                   const double beta, const double threshold, Tensor grad_input)
