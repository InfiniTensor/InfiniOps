#ifndef INFINI_OPS_BASE_LESS_EQUAL_TENSOR_H_
#define INFINI_OPS_BASE_LESS_EQUAL_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class LessEqualTensor : public Operator<LessEqualTensor> {
 public:
  LessEqualTensor(const Tensor self, const Tensor other, Tensor out)
