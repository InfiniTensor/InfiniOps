#ifndef INFINI_OPS_BASE_MULTILABEL_MARGIN_LOSS_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_MULTILABEL_MARGIN_LOSS_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class MultilabelMarginLossBackwardGradInput
    : public Operator<MultilabelMarginLossBackwardGradInput> {
 public:
  MultilabelMarginLossBackwardGradInput(const Tensor grad_output,
