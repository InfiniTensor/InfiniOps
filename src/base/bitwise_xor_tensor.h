#ifndef INFINI_OPS_BASE_BITWISE_XOR_TENSOR_H_
#define INFINI_OPS_BASE_BITWISE_XOR_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class BitwiseXorTensor : public Operator<BitwiseXorTensor> {
 public:
  BitwiseXorTensor(const Tensor self, const Tensor other, Tensor out)
