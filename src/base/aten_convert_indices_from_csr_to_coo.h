#ifndef INFINI_OPS_BASE_ATEN_CONVERT_INDICES_FROM_CSR_TO_COO_H_
#define INFINI_OPS_BASE_ATEN_CONVERT_INDICES_FROM_CSR_TO_COO_H_

#include "operator.h"

namespace infini::ops {

class AtenConvertIndicesFromCsrToCoo
    : public Operator<AtenConvertIndicesFromCsrToCoo> {
 public:
  AtenConvertIndicesFromCsrToCoo(const Tensor crow_indices,
