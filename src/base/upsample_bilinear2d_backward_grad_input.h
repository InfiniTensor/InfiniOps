#ifndef INFINI_OPS_BASE_UPSAMPLE_BILINEAR2D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_UPSAMPLE_BILINEAR2D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class UpsampleBilinear2dBackwardGradInput
    : public Operator<UpsampleBilinear2dBackwardGradInput> {
 public:
  UpsampleBilinear2dBackwardGradInput(const Tensor grad_output,
