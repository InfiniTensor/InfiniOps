#ifndef INFINI_OPS_BASE_SCATTER_SRC_H_
#define INFINI_OPS_BASE_SCATTER_SRC_H_

#include "operator.h"

namespace infini::ops {

class ScatterSrc : public Operator<ScatterSrc> {
 public:
  ScatterSrc(const Tensor self, const int64_t dim, const Tensor index,
