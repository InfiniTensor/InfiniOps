#ifndef INFINI_OPS_BASE_LOGICAL_XOR_H_
#define INFINI_OPS_BASE_LOGICAL_XOR_H_

#include "operator.h"

namespace infini::ops {

class LogicalXor : public Operator<LogicalXor> {
 public:
  LogicalXor(const Tensor input, const Tensor other, Tensor out)
