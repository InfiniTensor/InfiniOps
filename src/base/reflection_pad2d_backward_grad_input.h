#ifndef INFINI_OPS_BASE_REFLECTION_PAD2D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_REFLECTION_PAD2D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class ReflectionPad2dBackwardGradInput
    : public Operator<ReflectionPad2dBackwardGradInput> {
 public:
  ReflectionPad2dBackwardGradInput(const Tensor grad_output, const Tensor self,
