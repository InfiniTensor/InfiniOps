#ifndef INFINI_OPS_BASE_ATEN_UPSAMPLE_NEAREST_EXACT1D_BACKWARD_H_
#define INFINI_OPS_BASE_ATEN_UPSAMPLE_NEAREST_EXACT1D_BACKWARD_H_
...
class AtenUpsampleNearestExact1dBackward
    : public Operator<AtenUpsampleNearestExact1dBackward> {
 public:
  AtenUpsampleNearestExact1dBackward(const Tensor grad_output,
