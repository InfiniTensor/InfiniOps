#ifndef INFINI_OPS_BASE_INTERNAL_UPSAMPLE_BICUBIC2D_AA_BACKWARD_H_
#define INFINI_OPS_BASE_INTERNAL_UPSAMPLE_BICUBIC2D_AA_BACKWARD_H_
...
class UpsampleBicubic2dAaBackward
    : public Operator<UpsampleBicubic2dAaBackward> {
 public:
  UpsampleBicubic2dAaBackward(const Tensor grad_output,
