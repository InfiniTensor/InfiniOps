#ifndef INFINI_OPS_BASE_UPSAMPLE_NEAREST1D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_UPSAMPLE_NEAREST1D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class UpsampleNearest1dBackwardGradInput
    : public Operator<UpsampleNearest1dBackwardGradInput> {
 public:
  UpsampleNearest1dBackwardGradInput(const Tensor grad_output,
