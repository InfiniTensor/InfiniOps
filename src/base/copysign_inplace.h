#ifndef INFINI_OPS_BASE_COPYSIGN_INPLACE_H_
#define INFINI_OPS_BASE_COPYSIGN_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class CopysignInplace : public Operator<CopysignInplace> {
 public:
  CopysignInplace(Tensor input, const Tensor other)
  ...
  CopysignInplace(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
