#ifndef INFINI_OPS_BASE_ATEN_UPSAMPLE_NEAREST_EXACT3D_BACKWARD_H_
#define INFINI_OPS_BASE_ATEN_UPSAMPLE_NEAREST_EXACT3D_BACKWARD_H_
...
class AtenUpsampleNearestExact3dBackward
    : public Operator<AtenUpsampleNearestExact3dBackward> {
 public:
  AtenUpsampleNearestExact3dBackward(const Tensor grad_output,
