#ifndef INFINI_OPS_BASE_INTERNAL_SLOW_CONV2D_FORWARD_H_
#define INFINI_OPS_BASE_INTERNAL_SLOW_CONV2D_FORWARD_H_
...
class SlowConv2dForward : public Operator<SlowConv2dForward> {
 public:
  SlowConv2dForward(const Tensor input, const Tensor weight,
