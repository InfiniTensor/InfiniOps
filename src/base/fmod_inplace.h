#ifndef INFINI_OPS_BASE_FMOD_INPLACE_H_
#define INFINI_OPS_BASE_FMOD_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class FmodInplace : public Operator<FmodInplace> {
 public:
  FmodInplace(Tensor input, const double other)
  ...
  FmodInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
