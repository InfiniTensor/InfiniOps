#ifndef INFINI_OPS_BASE_MUL_INPLACE_H_
#define INFINI_OPS_BASE_MUL_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class MulInplace : public Operator<MulInplace> {
 public:
  MulInplace(Tensor input, const Tensor other)
  ...
  MulInplace(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
