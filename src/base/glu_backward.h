#ifndef INFINI_OPS_BASE_GLU_BACKWARD_H_
#define INFINI_OPS_BASE_GLU_BACKWARD_H_

#include "operator.h"

namespace infini::ops {

class GluBackward : public Operator<GluBackward> {
 public:
  GluBackward(const Tensor grad_output, const Tensor input, const int64_t dim,
              Tensor grad_input)
