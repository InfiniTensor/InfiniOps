#ifndef INFINI_OPS_BASE_ATEN_SLOW_CONV2D_FORWARD_H_
#define INFINI_OPS_BASE_ATEN_SLOW_CONV2D_FORWARD_H_
...
class AtenSlowConv2dForward : public Operator<AtenSlowConv2dForward> {
 public:
  AtenSlowConv2dForward(const Tensor input, const Tensor weight,
