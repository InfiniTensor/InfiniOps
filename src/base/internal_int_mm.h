#ifndef INFINI_OPS_BASE_INTERNAL_INT_MM_H_
#define INFINI_OPS_BASE_INTERNAL_INT_MM_H_

#include "operator.h"

namespace infini::ops::internal {

class IntMm : public Operator<IntMm> {
 public:
  IntMm(const Tensor input, const Tensor mat2, Tensor out)
