#ifndef INFINI_OPS_BASE_LT_H_
#define INFINI_OPS_BASE_LT_H_

#include "operator.h"

namespace infini::ops {

class Lt : public Operator<Lt> {
 public:
  Lt(const Tensor input, const double other, Tensor out)
  ...
  Lt(const Tensor input, const Tensor other, Tensor out)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        out_shape_{out.shape()},
  ...
  Lt(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
  ...
  Lt(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_shape_{other.shape()},
