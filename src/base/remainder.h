#ifndef INFINI_OPS_BASE_REMAINDER_H_
#define INFINI_OPS_BASE_REMAINDER_H_

#include "operator.h"

namespace infini::ops {

class Remainder : public Operator<Remainder> {
 public:
  Remainder(const Tensor input, const double other, Tensor out)
  ...
  Remainder(const Tensor input, const Tensor other, Tensor out)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        out_shape_{out.shape()},
  ...
  Remainder(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
  ...
  Remainder(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_shape_{other.shape()},
