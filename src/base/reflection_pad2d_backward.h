#ifndef INFINI_OPS_BASE_REFLECTION_PAD2D_BACKWARD_H_
#define INFINI_OPS_BASE_REFLECTION_PAD2D_BACKWARD_H_
...
class ReflectionPad2dBackward : public Operator<ReflectionPad2dBackward> {
 public:
  ReflectionPad2dBackward(const Tensor grad_output, const Tensor input,
