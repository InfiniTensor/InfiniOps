#ifndef INFINI_OPS_BASE_SORT_VALUES_STABLE_H_
#define INFINI_OPS_BASE_SORT_VALUES_STABLE_H_

#include "operator.h"

namespace infini::ops {

class SortValuesStable : public Operator<SortValuesStable> {
 public:
  SortValuesStable(const Tensor self, Tensor values, Tensor indices)
  ...
  virtual void operator()(const Tensor self, Tensor values,
