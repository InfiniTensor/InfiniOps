#ifndef INFINI_OPS_BASE_REFLECTION_PAD1D_BACKWARD_H_
#define INFINI_OPS_BASE_REFLECTION_PAD1D_BACKWARD_H_
...
class ReflectionPad1dBackward : public Operator<ReflectionPad1dBackward> {
 public:
  ReflectionPad1dBackward(const Tensor grad_output, const Tensor input,
