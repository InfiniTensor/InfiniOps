#ifndef INFINI_OPS_BASE_DIV_MODE_H_
#define INFINI_OPS_BASE_DIV_MODE_H_

#include "operator.h"

namespace infini::ops {

class DivMode : public Operator<DivMode> {
 public:
  DivMode(const Tensor self, const Tensor other, Tensor out)
