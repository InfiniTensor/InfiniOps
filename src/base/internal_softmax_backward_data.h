#ifndef INFINI_OPS_BASE_INTERNAL_SOFTMAX_BACKWARD_DATA_H_
#define INFINI_OPS_BASE_INTERNAL_SOFTMAX_BACKWARD_DATA_H_

#include "operator.h"

namespace infini::ops::internal {

class SoftmaxBackwardData : public Operator<SoftmaxBackwardData> {
 public:
  SoftmaxBackwardData(const Tensor grad_output, const Tensor output,
