#ifndef INFINI_OPS_BASE_ATEN_UPSAMPLE_NEAREST_EXACT2D_BACKWARD_H_
#define INFINI_OPS_BASE_ATEN_UPSAMPLE_NEAREST_EXACT2D_BACKWARD_H_
...
class AtenUpsampleNearestExact2dBackward
    : public Operator<AtenUpsampleNearestExact2dBackward> {
 public:
  AtenUpsampleNearestExact2dBackward(const Tensor grad_output,
