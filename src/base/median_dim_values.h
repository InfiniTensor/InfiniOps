#ifndef INFINI_OPS_BASE_MEDIAN_DIM_VALUES_H_
#define INFINI_OPS_BASE_MEDIAN_DIM_VALUES_H_

#include "operator.h"

namespace infini::ops {

class MedianDimValues : public Operator<MedianDimValues> {
 public:
  MedianDimValues(const Tensor self, const int64_t dim, Tensor values,
                  Tensor indices)
