#ifndef INFINI_OPS_BASE_SOFT_MARGIN_LOSS_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_SOFT_MARGIN_LOSS_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class SoftMarginLossBackwardGradInput
    : public Operator<SoftMarginLossBackwardGradInput> {
 public:
  SoftMarginLossBackwardGradInput(const Tensor grad_output, const Tensor self,
