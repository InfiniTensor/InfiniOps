#ifndef INFINI_OPS_BASE_GREATER_TENSOR_H_
#define INFINI_OPS_BASE_GREATER_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class GreaterTensor : public Operator<GreaterTensor> {
 public:
  GreaterTensor(const Tensor self, const Tensor other, Tensor out)
