#ifndef INFINI_OPS_BASE_REFLECTION_PAD3D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_REFLECTION_PAD3D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class ReflectionPad3dBackwardGradInput
    : public Operator<ReflectionPad3dBackwardGradInput> {
 public:
  ReflectionPad3dBackwardGradInput(const Tensor grad_output, const Tensor self,
