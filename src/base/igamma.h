#ifndef INFINI_OPS_BASE_IGAMMA_H_
#define INFINI_OPS_BASE_IGAMMA_H_

#include "operator.h"

namespace infini::ops {

class Igamma : public Operator<Igamma> {
 public:
  Igamma(const Tensor input, const Tensor other, Tensor out)
