#ifndef INFINI_OPS_BASE_IGAMMAC_H_
#define INFINI_OPS_BASE_IGAMMAC_H_

#include "operator.h"

namespace infini::ops {

class Igammac : public Operator<Igammac> {
 public:
  Igammac(const Tensor input, const Tensor other, Tensor out)
