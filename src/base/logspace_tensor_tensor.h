#ifndef INFINI_OPS_BASE_LOGSPACE_TENSOR_TENSOR_H_
#define INFINI_OPS_BASE_LOGSPACE_TENSOR_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class LogspaceTensorTensor : public Operator<LogspaceTensorTensor> {
 public:
  LogspaceTensorTensor(const Tensor start, const Tensor end,
