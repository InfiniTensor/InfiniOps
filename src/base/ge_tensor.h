#ifndef INFINI_OPS_BASE_GE_TENSOR_H_
#define INFINI_OPS_BASE_GE_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class GeTensor : public Operator<GeTensor> {
 public:
  GeTensor(const Tensor self, const Tensor other, Tensor out)
