#ifndef INFINI_OPS_BASE_FFT_IRFFTN_H_
#define INFINI_OPS_BASE_FFT_IRFFTN_H_
...
class FftIrfftn : public Operator<FftIrfftn> {
 public:
  FftIrfftn(const Tensor input, const std::optional<std::vector<int64_t>> s,
