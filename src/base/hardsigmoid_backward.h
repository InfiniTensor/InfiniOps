#ifndef INFINI_OPS_BASE_HARDSIGMOID_BACKWARD_H_
#define INFINI_OPS_BASE_HARDSIGMOID_BACKWARD_H_

#include "operator.h"

namespace infini::ops {

class HardsigmoidBackward : public Operator<HardsigmoidBackward> {
 public:
  HardsigmoidBackward(const Tensor grad_output, const Tensor input,
                      Tensor grad_input)
