#ifndef INFINI_OPS_BASE_INTERNAL_SOFTMAX_H_
#define INFINI_OPS_BASE_INTERNAL_SOFTMAX_H_
...
class Softmax : public Operator<Softmax> {
 public:
  Softmax(const Tensor input, const int64_t dim, const bool half_to_float,
          Tensor out)
