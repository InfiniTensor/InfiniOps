#ifndef INFINI_OPS_BASE_ATEN_ADDMM_ACTIVATION_H_
#define INFINI_OPS_BASE_ATEN_ADDMM_ACTIVATION_H_

#include "operator.h"

namespace infini::ops {

class AtenAddmmActivation : public Operator<AtenAddmmActivation> {
 public:
  AtenAddmmActivation(const Tensor input, const Tensor mat1, const Tensor mat2,
                      const double beta, const double alpha,
                      const bool use_gelu, Tensor out)
