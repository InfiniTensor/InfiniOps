#ifndef INFINI_OPS_BASE_LESS_TENSOR_H_
#define INFINI_OPS_BASE_LESS_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class LessTensor : public Operator<LessTensor> {
 public:
  LessTensor(const Tensor self, const Tensor other, Tensor out)
