#ifndef INFINI_OPS_BASE_FFT_FFTN_H_
#define INFINI_OPS_BASE_FFT_FFTN_H_
...
class FftFftn : public Operator<FftFftn> {
 public:
  FftFftn(const Tensor input, const std::optional<std::vector<int64_t>> s,
