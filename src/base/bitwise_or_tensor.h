#ifndef INFINI_OPS_BASE_BITWISE_OR_TENSOR_H_
#define INFINI_OPS_BASE_BITWISE_OR_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class BitwiseOrTensor : public Operator<BitwiseOrTensor> {
 public:
  BitwiseOrTensor(const Tensor self, const Tensor other, Tensor out)
