#ifndef INFINI_OPS_BASE_LESS_H_
#define INFINI_OPS_BASE_LESS_H_

#include "operator.h"

namespace infini::ops {

class Less : public Operator<Less> {
 public:
  Less(const Tensor input, const double other, Tensor out)
  ...
  Less(const Tensor input, const Tensor other, Tensor out)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        out_shape_{out.shape()},
  ...
  Less(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
  ...
  Less(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_shape_{other.shape()},
