#ifndef INFINI_OPS_BASE_CUMMAX_H_
#define INFINI_OPS_BASE_CUMMAX_H_

#include "operator.h"

namespace infini::ops {

class Cummax : public Operator<Cummax> {
 public:
  Cummax(const Tensor input, const int64_t dim, Tensor values, Tensor indices)
