#ifndef INFINI_OPS_BASE_LOGADDEXP2_H_
#define INFINI_OPS_BASE_LOGADDEXP2_H_

#include "operator.h"

namespace infini::ops {

class Logaddexp2 : public Operator<Logaddexp2> {
 public:
  Logaddexp2(const Tensor input, const Tensor other, Tensor out)
