#ifndef INFINI_OPS_BASE_THRESHOLD_BACKWARD_H_
#define INFINI_OPS_BASE_THRESHOLD_BACKWARD_H_

#include "operator.h"

namespace infini::ops {

class ThresholdBackward : public Operator<ThresholdBackward> {
 public:
  ThresholdBackward(const Tensor grad_output, const Tensor input,
