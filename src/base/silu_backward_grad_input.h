#ifndef INFINI_OPS_BASE_SILU_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_SILU_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class SiluBackwardGradInput : public Operator<SiluBackwardGradInput> {
 public:
  SiluBackwardGradInput(const Tensor grad_output, const Tensor self,
                        Tensor grad_input)
