#ifndef INFINI_OPS_BASE_ADAPTIVE_AVG_POOL3D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_ADAPTIVE_AVG_POOL3D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class AdaptiveAvgPool3dBackwardGradInput
    : public Operator<AdaptiveAvgPool3dBackwardGradInput> {
 public:
  AdaptiveAvgPool3dBackwardGradInput(const Tensor grad_output,
