#ifndef INFINI_OPS_BASE_MSE_LOSS_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_MSE_LOSS_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class MseLossBackwardGradInput : public Operator<MseLossBackwardGradInput> {
 public:
  MseLossBackwardGradInput(const Tensor grad_output, const Tensor self,
