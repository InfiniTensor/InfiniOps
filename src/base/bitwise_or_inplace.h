#ifndef INFINI_OPS_BASE_BITWISE_OR_INPLACE_H_
#define INFINI_OPS_BASE_BITWISE_OR_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class BitwiseOrInplace : public Operator<BitwiseOrInplace> {
 public:
  BitwiseOrInplace(Tensor input, const double other)
  ...
  BitwiseOrInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
