#ifndef INFINI_OPS_BASE_NANMEDIAN_DIM_VALUES_H_
#define INFINI_OPS_BASE_NANMEDIAN_DIM_VALUES_H_

#include "operator.h"

namespace infini::ops {

class NanmedianDimValues : public Operator<NanmedianDimValues> {
 public:
  NanmedianDimValues(const Tensor self, const int64_t dim, Tensor values,
                     Tensor indices)
  ...
  virtual void operator()(const Tensor self, const int64_t dim, Tensor values,
