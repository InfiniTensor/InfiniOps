#ifndef INFINI_OPS_BASE_NLL_LOSS_FORWARD_OUTPUT_H_
#define INFINI_OPS_BASE_NLL_LOSS_FORWARD_OUTPUT_H_

#include "operator.h"

namespace infini::ops {

class NllLossForwardOutput : public Operator<NllLossForwardOutput> {
 public:
  NllLossForwardOutput(const Tensor self, const Tensor target,
