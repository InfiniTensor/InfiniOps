#ifndef INFINI_OPS_BASE_ATEN_LINALG_SOLVE_EX_H_
#define INFINI_OPS_BASE_ATEN_LINALG_SOLVE_EX_H_

#include "operator.h"

namespace infini::ops {

class AtenLinalgSolveEx : public Operator<AtenLinalgSolveEx> {
 public:
  AtenLinalgSolveEx(const Tensor A, const Tensor B, const bool left,
                    const bool check_errors, Tensor result, Tensor LU,
                    Tensor pivots, Tensor info)
      : A_shape_{A.shape()},
