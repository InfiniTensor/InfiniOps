#ifndef INFINI_OPS_BASE_NOT_EQUAL_TENSOR_H_
#define INFINI_OPS_BASE_NOT_EQUAL_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class NotEqualTensor : public Operator<NotEqualTensor> {
 public:
  NotEqualTensor(const Tensor self, const Tensor other, Tensor out)
