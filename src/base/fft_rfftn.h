#ifndef INFINI_OPS_BASE_FFT_RFFTN_H_
#define INFINI_OPS_BASE_FFT_RFFTN_H_
...
class FftRfftn : public Operator<FftRfftn> {
 public:
  FftRfftn(const Tensor input, const std::optional<std::vector<int64_t>> s,
