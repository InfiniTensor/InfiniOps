#ifndef INFINI_OPS_BASE_ATEN_SLOW_CONV2D_BACKWARD_H_
#define INFINI_OPS_BASE_ATEN_SLOW_CONV2D_BACKWARD_H_
...
class AtenSlowConv2dBackward : public Operator<AtenSlowConv2dBackward> {
 public:
  AtenSlowConv2dBackward(const Tensor grad_output, const Tensor input,
                         const Tensor weight,
