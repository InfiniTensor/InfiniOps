#ifndef INFINI_OPS_BASE_BITWISE_AND_INPLACE_H_
#define INFINI_OPS_BASE_BITWISE_AND_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class BitwiseAndInplace : public Operator<BitwiseAndInplace> {
 public:
  BitwiseAndInplace(Tensor input, const double other)
  ...
  BitwiseAndInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
