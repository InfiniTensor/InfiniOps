#ifndef INFINI_OPS_BASE_SOFTSHRINK_BACKWARD_H_
#define INFINI_OPS_BASE_SOFTSHRINK_BACKWARD_H_

#include "operator.h"

namespace infini::ops {

class SoftshrinkBackward : public Operator<SoftshrinkBackward> {
 public:
  SoftshrinkBackward(const Tensor grad_output, const Tensor input,
