...
class LinalgCholeskyEx : public Operator<LinalgCholeskyEx> {
 public:
  LinalgCholeskyEx(const Tensor input, const bool upper,
                   const bool check_errors, Tensor L, Tensor info)
