#ifndef INFINI_OPS_BASE_ATEN_LINALG_SVD_H_
#define INFINI_OPS_BASE_ATEN_LINALG_SVD_H_
...
class AtenLinalgSvd : public Operator<AtenLinalgSvd> {
 public:
  AtenLinalgSvd(const Tensor A, const bool full_matrices, const bool compute_uv,
                const std::optional<std::string> driver, Tensor U, Tensor S,
                Tensor Vh)
      : A_shape_{A.shape()},
