#ifndef INFINI_OPS_BASE_LESS_INPLACE_H_
#define INFINI_OPS_BASE_LESS_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class LessInplace : public Operator<LessInplace> {
 public:
  LessInplace(Tensor input, const double other)
  ...
  LessInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
