#ifndef INFINI_OPS_BASE_FFT_FFT_H_
#define INFINI_OPS_BASE_FFT_FFT_H_
...
class FftFft : public Operator<FftFft> {
 public:
  FftFft(const Tensor input, const std::optional<int64_t> n, const int64_t dim,
