#ifndef INFINI_OPS_BASE_AVG_POOL3D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_AVG_POOL3D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class AvgPool3dBackwardGradInput : public Operator<AvgPool3dBackwardGradInput> {
 public:
  AvgPool3dBackwardGradInput(const Tensor grad_output, const Tensor self,
