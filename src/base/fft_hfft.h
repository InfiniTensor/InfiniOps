#ifndef INFINI_OPS_BASE_FFT_HFFT_H_
#define INFINI_OPS_BASE_FFT_HFFT_H_
...
class FftHfft : public Operator<FftHfft> {
 public:
  FftHfft(const Tensor input, const std::optional<int64_t> n, const int64_t dim,
