#ifndef INFINI_OPS_BASE_CONV2D_H_
#define INFINI_OPS_BASE_CONV2D_H_
...
class Conv2d : public Operator<Conv2d> {
 public:
  Conv2d(const Tensor input, const Tensor weight, std::optional<Tensor> bias,
      ...
      : metadata_{conv_detail::MakeMetadata<2>(
