#ifndef INFINI_OPS_BASE_FLOAT_POWER_INPLACE_H_
#define INFINI_OPS_BASE_FLOAT_POWER_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class FloatPowerInplace : public Operator<FloatPowerInplace> {
 public:
  FloatPowerInplace(Tensor input, const double exponent)
  ...
  FloatPowerInplace(Tensor input, const Tensor exponent)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
