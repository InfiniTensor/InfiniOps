#ifndef INFINI_OPS_BASE_LOG_SIGMOID_BACKWARD_H_
#define INFINI_OPS_BASE_LOG_SIGMOID_BACKWARD_H_

#include "operator.h"

namespace infini::ops {

class LogSigmoidBackward : public Operator<LogSigmoidBackward> {
 public:
  LogSigmoidBackward(const Tensor grad_output, const Tensor input,
