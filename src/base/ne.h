#ifndef INFINI_OPS_BASE_NE_H_
#define INFINI_OPS_BASE_NE_H_

#include "operator.h"

namespace infini::ops {

class Ne : public Operator<Ne> {
 public:
  Ne(const Tensor input, const double other, Tensor out)
  ...
  Ne(const Tensor input, const Tensor other, Tensor out)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        out_shape_{out.shape()},
  ...
  Ne(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
  ...
  Ne(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_shape_{other.shape()},
