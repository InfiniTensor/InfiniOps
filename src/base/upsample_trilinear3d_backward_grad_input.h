#ifndef INFINI_OPS_BASE_UPSAMPLE_TRILINEAR3D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_UPSAMPLE_TRILINEAR3D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class UpsampleTrilinear3dBackwardGradInput
    : public Operator<UpsampleTrilinear3dBackwardGradInput> {
 public:
  UpsampleTrilinear3dBackwardGradInput(const Tensor grad_output,
