#ifndef INFINI_OPS_BASE_TANH_BACKWARD_H_
#define INFINI_OPS_BASE_TANH_BACKWARD_H_

#include "operator.h"

namespace infini::ops {

class TanhBackward : public Operator<TanhBackward> {
 public:
  TanhBackward(const Tensor grad_output, const Tensor output, Tensor grad_input)
