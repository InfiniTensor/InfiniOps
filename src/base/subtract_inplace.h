#ifndef INFINI_OPS_BASE_SUBTRACT_INPLACE_H_
#define INFINI_OPS_BASE_SUBTRACT_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class SubtractInplace : public Operator<SubtractInplace> {
 public:
  SubtractInplace(Tensor input, const Tensor other, const double alpha)
  ...
  SubtractInplace(Tensor input, const double other, const double alpha)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        alpha_{alpha},
