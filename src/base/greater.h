#ifndef INFINI_OPS_BASE_GREATER_H_
#define INFINI_OPS_BASE_GREATER_H_

#include "operator.h"

namespace infini::ops {

class Greater : public Operator<Greater> {
 public:
  Greater(const Tensor input, const double other, Tensor out)
  ...
  Greater(const Tensor input, const Tensor other, Tensor out)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        out_shape_{out.shape()},
  ...
  Greater(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
  ...
  Greater(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_shape_{other.shape()},
