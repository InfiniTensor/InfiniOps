#ifndef INFINI_OPS_BASE_FILL_INPLACE_H_
#define INFINI_OPS_BASE_FILL_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class FillInplace : public Operator<FillInplace> {
 public:
  FillInplace(Tensor input, const double value)
  ...
  FillInplace(Tensor input, const Tensor value)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
