#ifndef INFINI_OPS_BASE_LE_INPLACE_H_
#define INFINI_OPS_BASE_LE_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class LeInplace : public Operator<LeInplace> {
 public:
  LeInplace(Tensor input, const double other)
  ...
  LeInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
