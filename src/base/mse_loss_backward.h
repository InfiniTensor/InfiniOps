#ifndef INFINI_OPS_BASE_MSE_LOSS_BACKWARD_H_
#define INFINI_OPS_BASE_MSE_LOSS_BACKWARD_H_

#include "operator.h"

namespace infini::ops {

class MseLossBackward : public Operator<MseLossBackward> {
 public:
  MseLossBackward(const Tensor grad_output, const Tensor input,
