#ifndef INFINI_OPS_BASE_FFT_RFFT2_H_
#define INFINI_OPS_BASE_FFT_RFFT2_H_
...
class FftRfft2 : public Operator<FftRfft2> {
 public:
  FftRfft2(const Tensor input, const std::optional<std::vector<int64_t>> s,
