#ifndef INFINI_OPS_BASE_BITWISE_OR_H_
#define INFINI_OPS_BASE_BITWISE_OR_H_

#include "operator.h"

namespace infini::ops {

class BitwiseOr : public Operator<BitwiseOr> {
 public:
  BitwiseOr(const Tensor input, const Tensor other, Tensor out)
  ...
  BitwiseOr(const Tensor input, const double other, Tensor out)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        out_shape_{out.shape()},
  ...
  BitwiseOr(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
  ...
  BitwiseOr(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_shape_{other.shape()},
