#ifndef INFINI_OPS_BASE_REPLICATION_PAD3D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_REPLICATION_PAD3D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class ReplicationPad3dBackwardGradInput
    : public Operator<ReplicationPad3dBackwardGradInput> {
 public:
  ReplicationPad3dBackwardGradInput(const Tensor grad_output, const Tensor self,
