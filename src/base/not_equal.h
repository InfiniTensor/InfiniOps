#ifndef INFINI_OPS_BASE_NOT_EQUAL_H_
#define INFINI_OPS_BASE_NOT_EQUAL_H_

#include "operator.h"

namespace infini::ops {

class NotEqual : public Operator<NotEqual> {
 public:
  NotEqual(const Tensor input, const double other, Tensor out)
  ...
  NotEqual(const Tensor input, const Tensor other, Tensor out)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        out_shape_{out.shape()},
  ...
  NotEqual(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
  ...
  NotEqual(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_shape_{other.shape()},
