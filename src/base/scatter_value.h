#ifndef INFINI_OPS_BASE_SCATTER_VALUE_H_
#define INFINI_OPS_BASE_SCATTER_VALUE_H_

#include "operator.h"

namespace infini::ops {

class ScatterValue : public Operator<ScatterValue> {
 public:
  ScatterValue(const Tensor self, const int64_t dim, const Tensor index,
