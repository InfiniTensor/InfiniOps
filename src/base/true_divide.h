#ifndef INFINI_OPS_BASE_TRUE_DIVIDE_H_
#define INFINI_OPS_BASE_TRUE_DIVIDE_H_

#include "operator.h"

namespace infini::ops {

class TrueDivide : public Operator<TrueDivide> {
 public:
  TrueDivide(const Tensor input, const Tensor other, Tensor out)
