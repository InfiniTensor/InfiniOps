#ifndef INFINI_OPS_BASE_AVG_POOL2D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_AVG_POOL2D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class AvgPool2dBackwardGradInput : public Operator<AvgPool2dBackwardGradInput> {
 public:
  AvgPool2dBackwardGradInput(const Tensor grad_output, const Tensor self,
