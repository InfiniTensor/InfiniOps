#ifndef INFINI_OPS_BASE_FRACTIONAL_MAX_POOL2D_OUTPUT_H_
#define INFINI_OPS_BASE_FRACTIONAL_MAX_POOL2D_OUTPUT_H_

#include "operator.h"

namespace infini::ops {

class FractionalMaxPool2dOutput : public Operator<FractionalMaxPool2dOutput> {
 public:
  FractionalMaxPool2dOutput(const Tensor self,
