#ifndef INFINI_OPS_BASE_REFLECTION_PAD3D_BACKWARD_H_
#define INFINI_OPS_BASE_REFLECTION_PAD3D_BACKWARD_H_
...
class ReflectionPad3dBackward : public Operator<ReflectionPad3dBackward> {
 public:
  ReflectionPad3dBackward(const Tensor grad_output, const Tensor input,
