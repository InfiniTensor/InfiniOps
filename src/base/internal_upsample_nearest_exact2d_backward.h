#ifndef INFINI_OPS_BASE_INTERNAL_UPSAMPLE_NEAREST_EXACT2D_BACKWARD_H_
#define INFINI_OPS_BASE_INTERNAL_UPSAMPLE_NEAREST_EXACT2D_BACKWARD_H_
...
class UpsampleNearestExact2dBackward
    : public Operator<UpsampleNearestExact2dBackward> {
 public:
  UpsampleNearestExact2dBackward(const Tensor grad_output,
