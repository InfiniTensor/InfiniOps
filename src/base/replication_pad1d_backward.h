#ifndef INFINI_OPS_BASE_REPLICATION_PAD1D_BACKWARD_H_
#define INFINI_OPS_BASE_REPLICATION_PAD1D_BACKWARD_H_
...
class ReplicationPad1dBackward : public Operator<ReplicationPad1dBackward> {
 public:
  ReplicationPad1dBackward(const Tensor grad_output, const Tensor input,
