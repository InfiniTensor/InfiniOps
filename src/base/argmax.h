#ifndef INFINI_OPS_BASE_ARGMAX_H_
#define INFINI_OPS_BASE_ARGMAX_H_
...
class Argmax : public Operator<Argmax> {
 public:
  Argmax(const Tensor input, const std::optional<int64_t> dim,
