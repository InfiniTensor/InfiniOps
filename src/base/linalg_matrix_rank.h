...
class LinalgMatrixRank : public Operator<LinalgMatrixRank> {
 public:
  ...
  LinalgMatrixRank(const Tensor input, const std::optional<Tensor> atol,
                   const std::optional<Tensor> rtol, const bool hermitian,
                   Tensor out)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
  ...
  LinalgMatrixRank(const Tensor input, const std::optional<double> atol,
                   const std::optional<double> rtol, const bool hermitian,
                   Tensor out)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
