#ifndef INFINI_OPS_BASE_GREATER_EQUAL_INPLACE_H_
#define INFINI_OPS_BASE_GREATER_EQUAL_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class GreaterEqualInplace : public Operator<GreaterEqualInplace> {
 public:
  GreaterEqualInplace(Tensor input, const double other)
  ...
  GreaterEqualInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
