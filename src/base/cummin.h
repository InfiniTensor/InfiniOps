#ifndef INFINI_OPS_BASE_CUMMIN_H_
#define INFINI_OPS_BASE_CUMMIN_H_

#include "operator.h"

namespace infini::ops {

class Cummin : public Operator<Cummin> {
 public:
  Cummin(const Tensor input, const int64_t dim, Tensor values, Tensor indices)
  ...
  virtual void operator()(const Tensor input, const int64_t dim, Tensor values,
