#ifndef INFINI_OPS_BASE_ATEN_UPSAMPLE_BICUBIC2D_AA_BACKWARD_H_
#define INFINI_OPS_BASE_ATEN_UPSAMPLE_BICUBIC2D_AA_BACKWARD_H_
...
class AtenUpsampleBicubic2dAaBackward
    : public Operator<AtenUpsampleBicubic2dAaBackward> {
 public:
  AtenUpsampleBicubic2dAaBackward(const Tensor grad_output,
