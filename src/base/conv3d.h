#ifndef INFINI_OPS_BASE_CONV3D_H_
#define INFINI_OPS_BASE_CONV3D_H_
...
class Conv3d : public Operator<Conv3d> {
 public:
  Conv3d(const Tensor input, const Tensor weight, std::optional<Tensor> bias,
      ...
      : metadata_{conv_detail::MakeMetadata<3>(
