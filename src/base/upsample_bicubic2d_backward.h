#ifndef INFINI_OPS_BASE_UPSAMPLE_BICUBIC2D_BACKWARD_H_
#define INFINI_OPS_BASE_UPSAMPLE_BICUBIC2D_BACKWARD_H_

#include "operator.h"

namespace infini::ops {

class UpsampleBicubic2dBackward : public Operator<UpsampleBicubic2dBackward> {
 public:
  UpsampleBicubic2dBackward(const Tensor grad_output,
                            const std::vector<int64_t> output_size,
                            const std::vector<int64_t> input_size,
                            const bool align_corners, const double scales_h,
                            const double scales_w, Tensor grad_input)
  ...
  virtual void operator()(const Tensor grad_output,
                          ...
                          const std::vector<int64_t> input_size,
                          const bool align_corners, const double scales_h,
                          const double scales_w, Tensor grad_input) const = 0;
