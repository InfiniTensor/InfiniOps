#ifndef INFINI_OPS_BASE_REPLICATION_PAD3D_BACKWARD_H_
#define INFINI_OPS_BASE_REPLICATION_PAD3D_BACKWARD_H_
...
class ReplicationPad3dBackward : public Operator<ReplicationPad3dBackward> {
 public:
  ReplicationPad3dBackward(const Tensor grad_output, const Tensor input,
