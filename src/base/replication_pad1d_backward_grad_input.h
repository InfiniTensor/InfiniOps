#ifndef INFINI_OPS_BASE_REPLICATION_PAD1D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_REPLICATION_PAD1D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class ReplicationPad1dBackwardGradInput
    : public Operator<ReplicationPad1dBackwardGradInput> {
 public:
  ReplicationPad1dBackwardGradInput(const Tensor grad_output, const Tensor self,
