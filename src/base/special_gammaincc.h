#ifndef INFINI_OPS_BASE_SPECIAL_GAMMAINCC_H_
#define INFINI_OPS_BASE_SPECIAL_GAMMAINCC_H_
...
class SpecialGammaincc : public Operator<SpecialGammaincc> {
 public:
  SpecialGammaincc(const Tensor self, const Tensor other, Tensor out)
