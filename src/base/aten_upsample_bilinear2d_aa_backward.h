#ifndef INFINI_OPS_BASE_ATEN_UPSAMPLE_BILINEAR2D_AA_BACKWARD_H_
#define INFINI_OPS_BASE_ATEN_UPSAMPLE_BILINEAR2D_AA_BACKWARD_H_
...
class AtenUpsampleBilinear2dAaBackward
    : public Operator<AtenUpsampleBilinear2dAaBackward> {
 public:
  AtenUpsampleBilinear2dAaBackward(const Tensor grad_output,
