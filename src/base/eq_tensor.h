#ifndef INFINI_OPS_BASE_EQ_TENSOR_H_
#define INFINI_OPS_BASE_EQ_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class EqTensor : public Operator<EqTensor> {
 public:
  EqTensor(const Tensor self, const Tensor other, Tensor out)
