#ifndef INFINI_OPS_BASE_FLOOR_DIVIDE_INPLACE_H_
#define INFINI_OPS_BASE_FLOOR_DIVIDE_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class FloorDivideInplace : public Operator<FloorDivideInplace> {
 public:
  FloorDivideInplace(Tensor input, const Tensor other)
  ...
  FloorDivideInplace(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
