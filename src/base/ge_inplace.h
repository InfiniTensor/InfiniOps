#ifndef INFINI_OPS_BASE_GE_INPLACE_H_
#define INFINI_OPS_BASE_GE_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class GeInplace : public Operator<GeInplace> {
 public:
  GeInplace(Tensor input, const double other)
  ...
  GeInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
