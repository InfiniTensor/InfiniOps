#ifndef INFINI_OPS_BASE_INTERNAL_UPSAMPLE_BICUBIC2D_AA_H_
#define INFINI_OPS_BASE_INTERNAL_UPSAMPLE_BICUBIC2D_AA_H_
...
class UpsampleBicubic2dAa : public Operator<UpsampleBicubic2dAa> {
 public:
  UpsampleBicubic2dAa(const Tensor input,
