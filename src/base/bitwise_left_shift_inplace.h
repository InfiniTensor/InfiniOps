#ifndef INFINI_OPS_BASE_BITWISE_LEFT_SHIFT_INPLACE_H_
#define INFINI_OPS_BASE_BITWISE_LEFT_SHIFT_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class BitwiseLeftShiftInplace : public Operator<BitwiseLeftShiftInplace> {
 public:
  BitwiseLeftShiftInplace(Tensor input, const Tensor other)
  ...
  BitwiseLeftShiftInplace(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
