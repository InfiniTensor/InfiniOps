#ifndef INFINI_OPS_BASE_SOFTPLUS_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_SOFTPLUS_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class SoftplusBackwardGradInput : public Operator<SoftplusBackwardGradInput> {
 public:
  SoftplusBackwardGradInput(const Tensor grad_output, const Tensor self,
