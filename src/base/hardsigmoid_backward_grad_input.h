#ifndef INFINI_OPS_BASE_HARDSIGMOID_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_HARDSIGMOID_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class HardsigmoidBackwardGradInput
    : public Operator<HardsigmoidBackwardGradInput> {
 public:
  HardsigmoidBackwardGradInput(const Tensor grad_output, const Tensor self,
                               Tensor grad_input)
