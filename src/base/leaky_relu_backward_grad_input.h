#ifndef INFINI_OPS_BASE_LEAKY_RELU_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_LEAKY_RELU_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class LeakyReluBackwardGradInput : public Operator<LeakyReluBackwardGradInput> {
 public:
  LeakyReluBackwardGradInput(const Tensor grad_output, const Tensor self,
                             const double negative_slope,
                             const bool self_is_result, Tensor grad_input)
