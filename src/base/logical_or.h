#ifndef INFINI_OPS_BASE_LOGICAL_OR_H_
#define INFINI_OPS_BASE_LOGICAL_OR_H_

#include "operator.h"

namespace infini::ops {

class LogicalOr : public Operator<LogicalOr> {
 public:
  LogicalOr(const Tensor input, const Tensor other, Tensor out)
