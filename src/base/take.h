#ifndef INFINI_OPS_BASE_TAKE_H_
#define INFINI_OPS_BASE_TAKE_H_
...
class Take : public Operator<Take> {
 public:
  Take(const Tensor self, const Tensor index, Tensor out)
  ...
  virtual void operator()(const Tensor self, const Tensor index,
                          Tensor out) const = 0;
