#ifndef INFINI_OPS_BASE_FFT_RFFT_H_
#define INFINI_OPS_BASE_FFT_RFFT_H_
...
class FftRfft : public Operator<FftRfft> {
 public:
  FftRfft(const Tensor input, const std::optional<int64_t> n, const int64_t dim,
