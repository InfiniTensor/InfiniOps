#ifndef INFINI_OPS_BASE_NE_TENSOR_H_
#define INFINI_OPS_BASE_NE_TENSOR_H_

#include "operator.h"

namespace infini::ops {

class NeTensor : public Operator<NeTensor> {
 public:
  NeTensor(const Tensor self, const Tensor other, Tensor out)
