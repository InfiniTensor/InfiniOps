#ifndef INFINI_OPS_BASE_SPECIAL_XLOGY_H_
#define INFINI_OPS_BASE_SPECIAL_XLOGY_H_

#include "operator.h"

namespace infini::ops {

class SpecialXlogy : public Operator<SpecialXlogy> {
 public:
  SpecialXlogy(const Tensor input, const Tensor other, Tensor out)
  ...
  SpecialXlogy(const Tensor input, const double other, Tensor out)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        out_shape_{out.shape()},
