#ifndef INFINI_OPS_BASE_ADAPTIVE_MAX_POOL2D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_ADAPTIVE_MAX_POOL2D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class AdaptiveMaxPool2dBackwardGradInput
    : public Operator<AdaptiveMaxPool2dBackwardGradInput> {
 public:
  AdaptiveMaxPool2dBackwardGradInput(const Tensor grad_output,
