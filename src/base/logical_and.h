#ifndef INFINI_OPS_BASE_LOGICAL_AND_H_
#define INFINI_OPS_BASE_LOGICAL_AND_H_

#include "operator.h"

namespace infini::ops {

class LogicalAnd : public Operator<LogicalAnd> {
 public:
  LogicalAnd(const Tensor input, const Tensor other, Tensor out)
