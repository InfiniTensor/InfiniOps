#ifndef INFINI_OPS_BASE_DIVIDE_MODE_H_
#define INFINI_OPS_BASE_DIVIDE_MODE_H_

#include "operator.h"

namespace infini::ops {

class DivideMode : public Operator<DivideMode> {
 public:
  DivideMode(const Tensor self, const Tensor other, Tensor out)
