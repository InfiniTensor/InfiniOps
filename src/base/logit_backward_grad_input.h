#ifndef INFINI_OPS_BASE_LOGIT_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_LOGIT_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class LogitBackwardGradInput : public Operator<LogitBackwardGradInput> {
 public:
  LogitBackwardGradInput(const Tensor grad_output, const Tensor self,
                         Tensor grad_input)
