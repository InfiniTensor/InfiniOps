#ifndef INFINI_OPS_BASE_EQ_INPLACE_H_
#define INFINI_OPS_BASE_EQ_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class EqInplace : public Operator<EqInplace> {
 public:
  EqInplace(Tensor input, const double other)
  ...
  EqInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
