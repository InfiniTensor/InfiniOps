#ifndef INFINI_OPS_BASE_MEDIAN_H_
#define INFINI_OPS_BASE_MEDIAN_H_

#include "operator.h"

namespace infini::ops {

class Median : public Operator<Median> {
 public:
  Median(const Tensor input, const int64_t dim, const bool keepdim,
