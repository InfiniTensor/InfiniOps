#ifndef INFINI_OPS_BASE_SCATTER_REDUCE_TWO_H_
#define INFINI_OPS_BASE_SCATTER_REDUCE_TWO_H_

#include "operator.h"

namespace infini::ops {

class ScatterReduceTwo : public Operator<ScatterReduceTwo> {
 public:
  ScatterReduceTwo(const Tensor self, const int64_t dim, const Tensor index,
