#ifndef INFINI_OPS_BASE_REFLECTION_PAD1D_BACKWARD_GRAD_INPUT_H_
#define INFINI_OPS_BASE_REFLECTION_PAD1D_BACKWARD_GRAD_INPUT_H_

#include "operator.h"

namespace infini::ops {

class ReflectionPad1dBackwardGradInput
    : public Operator<ReflectionPad1dBackwardGradInput> {
 public:
  ReflectionPad1dBackwardGradInput(const Tensor grad_output, const Tensor self,
