#ifndef INFINI_OPS_BASE_BITWISE_XOR_INPLACE_H_
#define INFINI_OPS_BASE_BITWISE_XOR_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class BitwiseXorInplace : public Operator<BitwiseXorInplace> {
 public:
  BitwiseXorInplace(Tensor input, const double other)
  ...
  BitwiseXorInplace(Tensor input, const Tensor other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
