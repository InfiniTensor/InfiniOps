#ifndef INFINI_OPS_BASE_ATEN_INT_MM_H_
#define INFINI_OPS_BASE_ATEN_INT_MM_H_

#include "operator.h"

namespace infini::ops {

class AtenIntMm : public Operator<AtenIntMm> {
 public:
  AtenIntMm(const Tensor input, const Tensor mat2, Tensor out)
