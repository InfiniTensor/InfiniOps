#ifndef INFINI_OPS_BASE_INTERNAL_UPSAMPLE_NEAREST_EXACT1D_BACKWARD_H_
#define INFINI_OPS_BASE_INTERNAL_UPSAMPLE_NEAREST_EXACT1D_BACKWARD_H_
...
class UpsampleNearestExact1dBackward
    : public Operator<UpsampleNearestExact1dBackward> {
 public:
  UpsampleNearestExact1dBackward(const Tensor grad_output,
