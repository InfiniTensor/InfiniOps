#ifndef INFINI_OPS_BASE_ADAPTIVE_MAX_POOL2D_BACKWARD_H_
#define INFINI_OPS_BASE_ADAPTIVE_MAX_POOL2D_BACKWARD_H_

#include "operator.h"

namespace infini::ops {

class AdaptiveMaxPool2dBackward : public Operator<AdaptiveMaxPool2dBackward> {
 public:
  AdaptiveMaxPool2dBackward(const Tensor grad_output, const Tensor input,
