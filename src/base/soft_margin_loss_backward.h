#ifndef INFINI_OPS_BASE_SOFT_MARGIN_LOSS_BACKWARD_H_
#define INFINI_OPS_BASE_SOFT_MARGIN_LOSS_BACKWARD_H_

#include "operator.h"

namespace infini::ops {

class SoftMarginLossBackward : public Operator<SoftMarginLossBackward> {
 public:
  SoftMarginLossBackward(const Tensor grad_output, const Tensor input,
