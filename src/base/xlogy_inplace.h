#ifndef INFINI_OPS_BASE_XLOGY_INPLACE_H_
#define INFINI_OPS_BASE_XLOGY_INPLACE_H_

#include "operator.h"

namespace infini::ops {

class XlogyInplace : public Operator<XlogyInplace> {
 public:
  XlogyInplace(Tensor input, const Tensor other)
  ...
  XlogyInplace(Tensor input, const double other)
      : input_shape_{input.shape()},
        input_strides_{input.strides()},
        input_type_{input.dtype()},
        other_{other},
