#ifndef INFINI_OPS_LINKED_TVM_FFI_THEAD_OPS_TOP_K_TOP_P_SAMPLING_FROM_LOGITS_FLASHINFER_H_
#define INFINI_OPS_LINKED_TVM_FFI_THEAD_OPS_TOP_K_TOP_P_SAMPLING_FROM_LOGITS_FLASHINFER_H_
...
template <>
class Operator<TopKTopPSamplingFromLogits, Device::Type::kThead, 16>
 ...
 private:
  ...
  void ReleaseStagingSlots() noexcept;
};

}  // namespace infini::ops

#endif  // INFINI_OPS_LINKED_TVM_FFI_THEAD_OPS_TOP_K_TOP_P_SAMPLING_FROM_LOGITS_FLASHINFER_H_
