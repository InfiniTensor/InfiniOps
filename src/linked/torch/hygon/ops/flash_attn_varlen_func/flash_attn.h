#ifndef INFINI_OPS_LINKED_TORCH_HYGON_OPS_FLASH_ATTN_VARLEN_FUNC_FLASH_ATTN_H_
#define INFINI_OPS_LINKED_TORCH_HYGON_OPS_FLASH_ATTN_VARLEN_FUNC_FLASH_ATTN_H_
...
template <>
class Operator<FlashAttnVarlenFunc, Device::Type::kHygon, 16>
...
#endif  // INFINI_OPS_LINKED_TORCH_HYGON_OPS_FLASH_ATTN_VARLEN_FUNC_FLASH_ATTN_H_
