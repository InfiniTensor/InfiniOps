#ifndef INFINI_OPS_LINKED_TORCH_THEAD_OPS_MOE_WNA16_GEMM_VLLM_H_
#define INFINI_OPS_LINKED_TORCH_THEAD_OPS_MOE_WNA16_GEMM_VLLM_H_
...
struct VllmMoeWna16Gemm : C10<Device::Type::kThead> {
...
extern template class TorchMoeWna16Gemm<
    ::infini::ops::linked::torch::thead::VllmMoeWna16Gemm>;
...
template <>
class Operator<MoeWna16Gemm, Device::Type::kThead, 16>
    : public linked::torch::TorchMoeWna16Gemm<
          linked::torch::thead::VllmMoeWna16Gemm> {
 public:
  using linked::torch::TorchMoeWna16Gemm<
      linked::torch::thead::VllmMoeWna16Gemm>::TorchMoeWna16Gemm;

  using linked::torch::TorchMoeWna16Gemm<
      linked::torch::thead::VllmMoeWna16Gemm>::operator();
};

}  // namespace infini::ops

#endif  // INFINI_OPS_LINKED_TORCH_THEAD_OPS_MOE_WNA16_GEMM_VLLM_H_
