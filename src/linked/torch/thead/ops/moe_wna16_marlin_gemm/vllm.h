#ifndef INFINI_OPS_LINKED_TORCH_THEAD_OPS_MOE_WNA16_MARLIN_GEMM_VLLM_H_
#define INFINI_OPS_LINKED_TORCH_THEAD_OPS_MOE_WNA16_MARLIN_GEMM_VLLM_H_
...
struct VllmMoeWna16MarlinGemm : C10<Device::Type::kThead> {
...
template <>
class Operator<MoeWna16MarlinGemm, Device::Type::kThead, 16>
    : public linked::torch::TorchMoeWna16MarlinGemm<
          linked::torch::thead::VllmMoeWna16MarlinGemm> {
 public:
  using linked::torch::TorchMoeWna16MarlinGemm<
      linked::torch::thead::VllmMoeWna16MarlinGemm>::TorchMoeWna16MarlinGemm;

  using linked::torch::TorchMoeWna16MarlinGemm<
      linked::torch::thead::VllmMoeWna16MarlinGemm>::operator();
};

}  // namespace infini::ops

#endif  // INFINI_OPS_LINKED_TORCH_THEAD_OPS_MOE_WNA16_MARLIN_GEMM_VLLM_H_
