#ifndef INFINI_OPS_LINKED_TORCH_MOORE_OPS_FLASH_ATTN_VARLEN_FUNC_MATE_H_
#define INFINI_OPS_LINKED_TORCH_MOORE_OPS_FLASH_ATTN_VARLEN_FUNC_MATE_H_
...
#endif  // INFINI_OPS_LINKED_TORCH_MOORE_OPS_FLASH_ATTN_VARLEN_FUNC_MATE_H_
