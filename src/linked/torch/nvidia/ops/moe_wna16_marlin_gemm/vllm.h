...
struct VllmMoeWna16MarlinGemm : C10<Device::Type::kNvidia> {
  static void Validate(const int64_t b_q_type_id, const bool has_global_scale) {
    constexpr int64_t kFloat4E2M1F = 562949953487106;
    TORCH_CHECK(
        b_q_type_id != kFloat4E2M1F,
  ...
  static void Call(at::Tensor a, at::Tensor out, at::Tensor b_q_weight,
                   at::Tensor b_scales, std::optional<at::Tensor> global_scale,
                   ...
                   bool is_ep, int64_t b_q_type_id, int64_t size_m,
                   int64_t size_n, int64_t size_k, bool is_full_k,
    ...
    stack.emplace_back(is_ep);
    stack.emplace_back(b_q_type_id);
