#ifndef INFINI_OPS_CAMBRICON_TORCH_FALLBACK_H_
#define INFINI_OPS_CAMBRICON_TORCH_FALLBACK_H_
...
namespace infini::ops::cambricon_torch_fallback {

inline at::Tensor ToAten(const Tensor& tensor) {
  return ToAtenTensor<Device::Type::kCambricon>(tensor);
}
