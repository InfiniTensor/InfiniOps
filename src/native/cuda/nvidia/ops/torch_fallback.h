#ifndef INFINI_OPS_NVIDIA_TORCH_FALLBACK_H_
#define INFINI_OPS_NVIDIA_TORCH_FALLBACK_H_
...
namespace infini::ops::nvidia_torch_fallback {

inline at::Tensor ToAten(const Tensor& tensor) {
  return ToAtenTensor<Device::Type::kNvidia>(tensor);
}
