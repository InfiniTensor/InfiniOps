...
# functional/default form and materialize the result into the caller-provided
# `out` tensor(s) via `copy_`.
...
def main() -> int:
    ...
    for name in op_names:
        ...
        emitted_paths = _emit(
            public_name, usable, emit_base=not _base_path(public_name).exists()
        )
