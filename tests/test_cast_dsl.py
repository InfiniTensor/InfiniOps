"""Tests for the DSL-generated Cast operator (implementation_index=1).

Validates that the DSL-generated CUDA and CPU code produces results
identical to PyTorch's `Tensor.to(dtype)`.
"""
...
def _cast_dsl(input, out):
    infini.ops.cast(input, out, implementation="dsl")
