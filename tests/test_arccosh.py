...
def test_arccosh(
    ...
    return Payload(
        lambda input, out: _arccosh(input, out, implementation_index),
        _torch_arccosh,
        (input, out),
        {},
        rtol=rtol,
...
def _arccosh(input, out, implementation_index):
    infini.ops.arccosh(
        input,
        out,
...
def _torch_arccosh(input, out):
    out.copy_(torch.arccosh(input))
