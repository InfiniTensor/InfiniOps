...
def _gelutanh_infinilm(input, out):
    infini.ops.gelutanh_infinilm(input, out, stream=get_stream(input.device))

    return out


def _torch_gelutanh_infinilm(input, out):
