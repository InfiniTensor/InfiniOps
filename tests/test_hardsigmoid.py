...
def test_hardsigmoid(
    ...
    return Payload(
        lambda input, out: _hardsigmoid(input, out, implementation_index),
        _torch_hardsigmoid,
        (input, out),
        {},
        rtol=rtol,
...
def _hardsigmoid(input, out, implementation_index):
    infini.ops.hardsigmoid(
        input,
        out,
...
def _torch_hardsigmoid(input, out):
    out.copy_(F.hardsigmoid(input))
