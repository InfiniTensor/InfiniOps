...
def test_arctanh(
    ...
    return Payload(
        lambda input, out: _arctanh(input, out, implementation_index),
        _torch_arctanh,
        (input, out),
        {},
        rtol=rtol,
...
def _arctanh(input, out, implementation_index):
    infini.ops.arctanh(
        input,
        out,
...
def _torch_arctanh(input, out):
    out.copy_(torch.arctanh(input))
