...
def test_minimum(
    ...
    return Payload(
        lambda input, other, out: _minimum(input, other, out, implementation_index),
        _torch_minimum,
        (input, other, out),
        {},
        rtol=rtol,
...
def _minimum(input, other, out, implementation_index):
    infini.ops.minimum(
        input,
        other,
        out,
...
def _torch_minimum(input, other, out):
    out.copy_(torch.minimum(input, other))
